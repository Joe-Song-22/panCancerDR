...
source_data = pd.read_csv('/data/sr/Sorafenib_matched_data.csv')
...
t_1 = target_data[target_data['label'] == 22].iloc[:, 3:10003].values
...
s1 = np.concatenate((x_22, x_2, x_3, x_4, x_5, x_6, x_7, x_8, x_9, x_10, x_11, x_12, x_13, x_14, x_15, x_16, x_17, x_18, x_19, x_20, ), axis=0)
s1 = standardize_matrix(s1)
s1 = fill_nan_with_small_number(s1)
l1 = torch.cat((l[21], l[1], l[2], l[3], l[4], l[5], l[6], l[7], l[8], l[9], l[10], l[11], l[12], l[13], l[14], l[15], l[16], l[17], l[18], l[19],), dim=0)
...
r1 = np.concatenate((r_22, r_2, r_3, r_4, r_5, r_6, r_7, r_8, r_9, r_10, r_11, r_12, r_13, r_14, r_15, r_16, r_17, r_18, r_19, r_20,), axis=0)
...
model = Model(s1.shape[1], 1024,740, bs).to(device)
...
pd.DataFrame(tlabel_).to_csv('TCGA_Sorafenib_tlable.csv')
pd.DataFrame(tpred_).to_csv('TCGA_Sorafenib_tprde.csv')
...
plt.legend()
plt.title('features of TCGA_Sorafenib')
plt.savefig('TCGA_Sorafenib.jpg', dpi=500)
total_labels = total_labels.cpu().numpy()
total_feature = total_feature.numpy()
total_response = total_response.numpy()
pd.DataFrame(total_labels).to_csv('TCGA_Sorafenib_labels.csv')
pd.DataFrame(total_feature).to_csv('TCGA_Sorafenib_feature.csv')
pd.DataFrame(total_response).to_csv('TCGA_Sorafenib_response.csv')